		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("pfptmeta_trusted_network.network", "criteria.0.resolved_address_config.#", "0"),
					resource.TestCheckResourceAttr("pfptmeta_trusted_network.network",
					...
					resource.TestCheckResourceAttr("pfptmeta_trusted_network.network", "criteria.1.external_ip_config.#", "0"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("pfptmeta_trusted_network.network", "criteria.1.resolved_address_config.#", "0"),
					resource.TestCheckResourceAttr("pfptmeta_trusted_network.network",
					...
					resource.TestCheckResourceAttr("pfptmeta_trusted_network.network", "criteria.0.external_ip_config.#", "0"),
				),
			},
		},
	})
