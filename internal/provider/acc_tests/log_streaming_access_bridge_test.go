		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.casb_log_stream", "export_logs.1", "webfilter"),

					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.casb_log_stream",
						"proofpoint_casb_config.0.region", "EU"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.casb_log_stream",
						"proofpoint_casb_config.0.tenant_id", "tenant_70e4b2a567a24159ad6b495ba56b3620"),

					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.qradar_http_log_stream",
						"qradar_http_config.0.url", "http://qradar.url:1234"),

					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.s3_log_stream",
						"s3_config.0.bucket", "mybucket"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.s3_log_stream",
						"s3_config.0.compress", "true"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.s3_log_stream",
						"s3_config.0.prefix", "mybucketstream"),

					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.splunk_http_log_stream",
						"splunk_http_config.0.publicly_accessible", "false"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.splunk_http_log_stream",
						"splunk_http_config.0.token", "token"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.splunk_http_log_stream",
						"splunk_http_config.0.url", "https://splunk.url"),

					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.syslog_log_stream",
						"syslog_config.0.host", "syslog.hostname.com"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.syslog_log_stream",
						"syslog_config.0.port", "518"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.syslog_log_stream",
						"syslog_config.0.proto", "tcp"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.casb_log_stream", "export_logs.1", "traffic"),

					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.casb_log_stream",
						"proofpoint_casb_config.0.region", "US"),
					resource.TestCheckResourceAttr(
						"pfptmeta_log_streaming_access_bridge.casb_log_stream",
						"proofpoint_casb_config.0.tenant_id", "tenant_70e4b2a567a24159ad6b495ba56b3621"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"data.pfptmeta_log_streaming_access_bridge.log_stream", "export_logs.1", "webfilter"),
